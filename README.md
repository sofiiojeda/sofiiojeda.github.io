...
<div class="slideshow-container">
 <div class="armin">
    <div class="mySlides fade">
        ...
        <img src="img/tunrutunrurutun.png" style="width:100%">
        <div class="text">(. ❛ ᴗ ❛.)</div>
    </div>

    <div class="mySlides fade">
        <div class="numbertext">2 / 3</div>
        <img src="img/Yatoesguapo.png" style="width:100%">
        <div class="text">(. ❛ ᴗ ❛.)</div>
    </div>

    <div class="mySlides fade">
        <div class="numbertext"> 3 / 3</div>
        <img src="img/ifyourlying.png" style="width:100%">
        <div class="text">(. ❛ ᴗ ❛.)</div>
    </div>
